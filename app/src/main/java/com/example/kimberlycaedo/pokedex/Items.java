...
public class Items extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGridViewMove = (ListView) findViewById(R.id.gridView_move1);
        ...
        mmoves.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Items.this, Move.class);
                Items.this.startActivity(intent);
            }
        });
        ...
        mlocation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Items.this, Location.class);
                Items.this.startActivity(intent);
            }
        });
    }
...
//                            mMove.setmName(tempObj.getString("name"));
                            ...
                            Toast.makeText(Items.this, tempObj.getString("name"), Toast.LENGTH_SHORT).show();
                        }
